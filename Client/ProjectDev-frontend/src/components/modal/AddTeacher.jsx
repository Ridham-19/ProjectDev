      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => { dispatch(toggleTeacherModal()) }} className="text-slate-500 hover:text-slate-700 ">
              <X className="w-6 h-6" />
            </button>
          </div>
          ...
          <form onSubmit={handleCreateTeacher} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 pt-4">
              <Button type="button" className="text-red-500 hover:text-red-700 bg-slate-100 hover:bg-red-100" onClick={() => { dispatch(toggleTeacherModal()) }}>Cancel</Button>

              <Button type="submit" className="text-blue-500 hover:text-blue-700 bg-slate-100 hover:bg-blue-100">Add Teacher</Button>
            </div>
